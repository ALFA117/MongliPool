...
export const translations = {
  ...
  auditor: {
    ...
    viewKeyTitle: { es: "Llave de vista", en: "View key" },
    viewKeyWarning: {
      es: "Solo el auditor autorizado de Mongli DAO tiene esta llave. Mantenla confidencial. Esta página no la transmite a ningún servidor.",
      en: "Only Mongli DAO's authorized auditor has this key. Keep it confidential. This page does not transmit it to any server.",
    },
    viewKeyPlaceholder: { es: "Llave de vista (hex 64 chars o base64)", en: "View key (hex 64 chars or base64)" },
